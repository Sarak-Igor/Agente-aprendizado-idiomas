...
# O ThreadPoolExecutor local foi removido em favor do BackgroundTaskManager centralizado
...
async def process_video(
    ...
    try:
        ...
        # Executa processamento em background via manager centralizado
        background_task_manager.run_task(
