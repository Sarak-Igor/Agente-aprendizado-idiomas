...
class BlueprintRunner:
    ...
    async def _execute_tool(self, node: Dict[str, Any], context: Dict[str, Any]):
        # Funcionalidade de ferramentas MCP desativada temporariamente
        return {"error": "Execução de ferramentas MCP desativada."}
